...
$this->title = Yii::t('gestion', 'Webs específicas');
...
$dataProvider = new ArrayDataProvider([
    ...
    'sort' => [
        'attributes' => ['estudio_id_nk', 'estudio.nombre', 'centro.nombre', 'id_nk',],
        'defaultOrder' => [
...
echo Html::a('<i class="glyphicon glyphicon-repeat"></i>  '.Yii::t('gestion', 'Cargar webs específicas del año anterior'),
   ['gestion/cargar-webs-especificas-anterior', 'tipo' => $tipo],
...
echo GridView::widget([
    ...
    'columns' => [
        [
            ...
            'label' => Yii::t('cruds', 'URL de la web específica'),
            'value' => function ($plan) {
                return Html::a(
                    Html::encode($plan->url_web_plan),
                    $plan->url_web_plan
                );
            },
            'format' => 'html',
            ...
            'buttons' => [
                'actualizar-url-web-plan' => function ($url, $model, $key) {
                    $options = [
            ...
            // 'controller' => 'gestion',
            'template' => '{actualizar-url-web-plan}',
