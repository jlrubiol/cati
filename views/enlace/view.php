 ...
 * @var app\models\Enlace $model
 */
$copyParams = $model->attributes;

$this->title = Yii::t('models', 'Enlace');
$this->params['breadcrumbs'][] = ['label' => Yii::t('models', 'Enlaces'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => (string)$model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = Yii::t('cruds', 'View');
?>
<div class="giiant-crud enlace-view">
	...
	['create', 'id' => $model->id, 'Enlace'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\Enlace'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	...
	['enlace-lang/create', 'EnlaceLang' => ['enlace_id' => $model->id]],
		...
		'columns' => [
			[
				...
				'urlCreator' => function ($action, $model, $key, $index) {
					...
					$params[0] = 'enlace-lang' . '/' . $action;
					$params['EnlaceLang'] = ['enlace_id' => $model->primaryKey()[0]];
					return $params;
				},
				'buttons'    => [

				],
				'controller' => 'enlace-lang'
			],
			'id',
			'language',
			'nombre',
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['app\models\Enlace'],
				'active'  => true,
			],
			[
