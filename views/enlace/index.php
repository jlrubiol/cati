 ...
 */
$this->title = Yii::t('models', 'Enlaces');
...
?>
<div class="giiant-crud enlace-index">
...
\yii\bootstrap\ButtonDropdown::widget(
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['enlace-lang/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('models', 'Enlace Lang') . '</i>',
				],
