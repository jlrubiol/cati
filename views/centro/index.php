...
$this->title = Yii::t('models', 'Centros');
...
?>
<div class="giiant-crud centro-index">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Plan'),
                                ...
                                [
                'url' => ['centro-lang/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Centro Lang'),
            ],
