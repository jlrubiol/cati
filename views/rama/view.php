...
<div class="giiant-crud rama-view">
	...
	['create', 'id' => $model->id, 'Rama'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\Rama'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	...
	['estudio/create', 'Estudio' => ['rama_id' => $model->id]],
		...
		'columns' => [
			[
				...
				'urlCreator' => function ($action, $model, $key, $index) {
					...
					$params['Estudio'] = ['rama_id' => $model->primaryKey()[0]];
					return $params;
				},
				'buttons'    => [
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	...
	['rama-lang/create', 'RamaLang' => ['rama_id' => $model->id]],
	['class'=>'btn btn-success btn-xs']
); ?>
</div>
</div>
		...
		'columns' => [
			[
				...
				'urlCreator' => function ($action, $model, $key, $index) {
					// using the column name as key, not mapping to 'id' like the standard generator
					$params = is_array($key) ? $key : [$model->primaryKey()[0] => (string) $key];
					$params[0] = 'rama-lang' . '/' . $action;
					$params['RamaLang'] = ['rama_id' => $model->primaryKey()[0]];
					return $params;
				},
				'buttons'    => [

				],
				'controller' => 'rama-lang'
			],
			'id',
			'language',
			'nombre',
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['app\models\Rama'],
				'active'  => true,
			],
			[
