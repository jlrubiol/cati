...
$form->field($model, 'pagina_id')->dropDownList(
	\yii\helpers\ArrayHelper::map(app\models\Pagina::find()->all(), 'id', 'id'),
	[
		'prompt' => Yii::t('cruds', 'Select'),
		'disabled' => (isset($relAttributes) && isset($relAttributes['pagina_id'])),
	]
); ?>

<!-- attribute cuerpo -->
			<?php echo $form->field($model, 'cuerpo')->textarea(['rows' => 6]) ?>
