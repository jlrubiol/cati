 ...
 */
$this->title = Yii::t('models', 'Plan Preguntas');
...
?>
<div class="giiant-crud plan-pregunta-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Plan Preguntas') ?>
        <small>
            List
        </small>
    </h1>
	...
	[
		...
		'dropdown' => [
			...
			'items' => [
				...
				[
					'url' => ['plan-pregunta-lang/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Plan Pregunta Lang'),
				],
