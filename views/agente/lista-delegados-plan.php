<?php
/**
 * Vista de la lista de los delegados del coordinador de un plan de estudios.
 *
...
$this->title = sprintf(Yii::t('gestion', 'Delegados del coordinador del plan %d'), $plan->id_nk);
...
<?php
$msg = "En esta página puede gestionar los delegados del coordinador de un plan de estudios.\n"
  . 'Un delegado es una persona que ayuda al coordinador del plan a <b>gestionar la web de estudios</b>'
...
echo Html::a(
    ...
    ['crear-delegado', 'plan_id' => $plan->id],
    ['class' => 'btn btn-info']
); ?><br><br>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) use ($plan) {
                    $params = ["{$action}-delegado", 'id' => $model->id, 'plan_id' => $plan->id];
