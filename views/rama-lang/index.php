 ...
 */
$this->title = Yii::t('models', 'Rama Langs');
...
?>
<div class="giiant-crud rama-lang-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Rama Langs') ?>
        <small>
            List
        </small>
    </h1>
	...
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['rama/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-left">&nbsp;' . Yii::t('models', 'Rama') . '</i>',
				],
