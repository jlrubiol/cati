<?php
/**
 * Fragmento de vista del formulario para editar los datos de un programa de doctorado.
 *
...
$form = ActiveForm::begin([
    ...
    'id' => 'Doctorado',  // formName del modelo
    'layout' => 'horizontal',
]);
...
// DATOS A TRATAR. Los campos están definidos en el modelo `Doctorado` (tabla `DATUZ_doctorado`).
if ($esCoorDele) {
    # Usuario es coordinador del estudio
    ...
    # Usuario es Escuela de Doctorado
    // 1.9.b. Porcentaje de estudiantes con beca distinta de las contempladas en indicador 1.9
    echo $form->field($model, 'porc_alumnos_beca_distinta')->textInput(['maxlength' => true]) . "\n\n";
