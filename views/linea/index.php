...
$this->title = Yii::t('models', 'Lineas');
...
?>
<div class="giiant-crud linea-index">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Estudio'),
                                ...
                                [
                'url' => ['linea-lang/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Linea Lang'),
            ],
