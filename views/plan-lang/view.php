...
<div class="giiant-crud plan-lang-view">
	...
	['create', 'id' => $model->id, 'PlanLang'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\PlanLang'); ?>
    ...
    <?php echo DetailView::widget([
		...
		'attributes' => [
			...
			[
				'format' => 'html',
				'attribute' => 'plan_id',
				'value' => ($model->getPlan()->one() ?
					Html::a('<i class="glyphicon glyphicon-list"></i>', ['plan/index']).' '.
					Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getPlan()->one()->id, ['plan/view', 'id' => $model->getPlan()->one()->id, ]).' '.
					Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'PlanLang'=>['plan_id' => $model->plan_id]])
					:
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['app\models\PlanLang'],
				'active'  => true,
			],
		]
	]
