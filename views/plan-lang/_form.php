...
$form->field($model, 'plan_id')->dropDownList(
	\yii\helpers\ArrayHelper::map(app\models\Plan::find()->all(), 'id', 'id'),
	[
		'prompt' => Yii::t('cruds', 'Select'),
		'disabled' => (isset($relAttributes) && isset($relAttributes['plan_id'])),
	]
); ?>

<!-- attribute notas -->
			<?php echo $form->field($model, 'notas')->textarea(['rows' => 6]) ?>
