...
$this->title = Yii::t('models', 'Informe Preguntas');
...
?>
<div class="giiant-crud informe-pregunta-index">
...
//         ?>
    ...
    <h1>
        <?= Yii::t('models', 'Informe Preguntas') ?>
        <small>
            List
        </small>
    </h1>
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Informe Respuesta'),
                                ...
                                [
                'url' => ['informe-pregunta-lang/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Informe Pregunta Lang'),
            ],
