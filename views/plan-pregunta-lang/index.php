 ...
 */
$this->title = Yii::t('models', 'Plan Pregunta Langs');
...
?>
<div class="giiant-crud plan-pregunta-lang-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Plan Pregunta Langs') ?>
        <small>
            List
        </small>
    </h1>
		...
		'columns' => [
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->getPlanPregunta()->one()) {
