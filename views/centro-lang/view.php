...
<div class="giiant-crud centro-lang-view">
	...
	['create', 'id' => $model->id, 'CentroLang'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\CentroLang'); ?>
		...
		'attributes' => [
			...
			[
				...
				'value' => ($model->getCentro()->one() ?
					...
					Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'CentroLang'=>['centro_id' => $model->centro_id]])
					:
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['app\models\CentroLang'],
				'active'  => true,
			],
		]
	]
