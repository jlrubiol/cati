 ...
 */
$this->title = Yii::t('models', 'Seccions');
...
?>
<div class="giiant-crud seccion-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Seccions') ?>
        <small>
            List
        </small>
    </h1>
...
\yii\bootstrap\ButtonDropdown::widget(
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['informacion/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Informacion'),
				],
