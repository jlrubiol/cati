<?php
/**
 * Vista para completar una acción de un plan de innovación y mejora.
 *
...
$this->title = Yii::t('cati', 'Completar acción');
...
$this->params['breadcrumbs'][] = Yii::t('cati', 'Completar');
...
<?php echo $this->render('_formulario_completar', [
    'respuesta' => $respuesta,
    'estudio' => $estudio,
    'pregunta' => $pregunta,
]); ?>
