...
<div class="giiant-crud pagina-view">
	...
	['create', 'id' => $model->id, 'Pagina'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\Pagina'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	...
	['pagina-lang/create', 'PaginaLang' => ['pagina_id' => $model->id]],
		...
		'columns' => [
			[
				...
				'urlCreator' => function ($action, $model, $key, $index) {
					...
					$params[0] = 'pagina-lang' . '/' . $action;
					$params['PaginaLang'] = ['pagina_id' => $model->primaryKey()[0]];
					return $params;
				},
				'buttons'    => [

				],
				'controller' => 'pagina-lang'
			],
			'id',
			'language',
			'titulo',
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['app\models\Pagina'],
				'active'  => true,
			],
			[
