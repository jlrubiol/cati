...
?>
<div class="giiant-crud pagina-index">
...
\yii\bootstrap\ButtonDropdown::widget(
    [
        ...
        'dropdown' => [
            ...
            'items' => [
                [
                    'url' => ['pagina-lang/index'],
                    'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;'.Yii::t('models', 'Pagina Lang').'</i>',
                ],
