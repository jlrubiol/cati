 ...
 */
$this->title = Yii::t('models', 'Pagina') . " " . $model->id . ', ' . Yii::t('cruds', 'Edit');
$this->params['breadcrumbs'][] = ['label' => Yii::t('models', 'Pagina'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => (string)$model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = Yii::t('cruds', 'Edit');
?>
<div class="giiant-crud pagina-update">

    <h1>
        <?php echo Yii::t('models', 'Pagina') ?>
        <small>
                        <?php echo $model->id ?>
        </small>
    </h1>
