...
$this->title = Yii::t('models', 'Linea Langs');
...
?>
<div class="giiant-crud linea-lang-index">
...
//         ?>
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                'url' => ['linea/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Linea'),
            ],
        ...
        'columns' => [
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->linea) {
			            return Html::a($rel->id, ['linea/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
