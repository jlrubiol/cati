...
<record>
    ...
    <datafield tag="037" ind1=" " ind2=" ">
        <subfield code="a">CALTITU_INFAUTOEVAL-<?php echo $anyo + 1; ?>-<?php echo $estudio->id_nk; ?></subfield>
    </datafield>
    ...
    <datafield tag="245" ind1="0" ind2="0">
        ...
        <subfield code="a">Informe de Evaluación de la Calidad de
    ...
    <datafield tag="FFT" ind1=" " ind2=" ">
        <subfield code="a"><?php echo Url::home(true); ?>pdf/informes/<?php echo $anyo; ?>/informe-es-<?php echo $estudio->id_nk; ?>-v<?php echo InformePublicado::MAX_VERSION_INFORME_DOCT; ?>.pdf</subfield>
        <subfield code="d">Informe de autoevaluación</subfield>
    </datafield>
    ...
    foreach ($estudio->getCentros() as $centro) {
        ...
        <datafield tag="980" ind1=" " ind2=" ">
            <subfield code="a">CALTITU_INFAUTOEVAL</subfield>
